...
(function ($) {
    ...
    TimeSlider.DEFAULTS = {
        ...
        on_click_timecell_callback: null,
    ...
    TimeSlider.prototype.set_options = function (options) {
        ...
        if (options.start_timestamp) {
            ...
            if (options.start_timestamp != this.options.start_timestamp) {
                this.options.start_timestamp = options.start_timestamp;
    ...
    TimeSlider.prototype.graduation_title = function (datetime) {
        if (this.options.show_date_on_ruler) {
    ...
    TimeSlider.prototype.add_cell = function (timecell) {
        ...
        if (!this.$ruler.find('#' + timecell['_id']).length) {
            ...
            this.$ruler.append(
                ...
                '<span class="time-cell-duration">' +
                _this.options.cell_prefix_label + ' ' +
                this.time_duration(
            ...
            if (typeof this.options.on_click_timecell_callback == 'function') {
                t_element.click(function () {
                    ...
                    _this.options.on_click_timecell_callback(p_id, start, stop);
                });
            }
